document.addEventListener('DOMContentLoaded', function () {
    ...
    var downloadButton = document.getElementById('download-pdf-button'); // Added download button
    ...
    downloadButton.addEventListener('click', function () {
        var element = document.getElementById('resume-output'); // Select the div you want to convert to PDF
        if (element) {
            html2pdf()
                .from(element)
